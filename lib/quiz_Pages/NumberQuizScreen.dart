...
import 'package:isu/screens/ResultScreen.dart';
...
class NumberQuizScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return NumberQuizScreenBody();
  }
}

class NumberQuizScreenBody extends State {
  var questions = <Words>[];
  ...
  void questionCounterControl() {
    ...
    if (questionCounter != 3) {
      ...
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => ResultScreen(trueCounter: trueCounter)));
    }
  }
